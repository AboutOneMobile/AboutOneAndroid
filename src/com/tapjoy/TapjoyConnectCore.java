...
public class TapjoyConnectCore
{
	...
	{
		requestTapjoyConnect(applicationContext, app_ID, secret_Key, TapjoyConnectFlag.NONE);
	}
	 ...
	 */
	public static void requestTapjoyConnect(Context applicationContext, String app_ID, String secret_Key, int connectFlags)
	{
		appID = app_ID;
	...
	private static String getParamsWithoutAppID()
	{
		...
		if ((flags & TapjoyConnectFlag.SHA2_UDID) != 0)
		{
